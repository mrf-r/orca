/******************************************************************************
 * @file     massstorage.h
 * @brief    NUC123 series USB mass storage header file
 *
 * @note
...
/******************************************************************************/
/** @addtogroup NUC123_USBD_Mass_Exported_Struct NUC123 USBD Mass Exported Struct
  NUC123 USBD Mass Specific Struct
  @{
*/
