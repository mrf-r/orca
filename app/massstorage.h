/******************************************************************************
 * @file     massstorage.h
 * @brief    M451 series USB mass storage header file
 *
 * @note
...
/******************************************************************************/
/** @addtogroup M451_USBD_Mass_Exported_Struct M451 USBD Mass Exported Struct
  M451 USBD Mass Specific Struct
  @{
*/
...
void MSC_ReadCapacity(uint32_t u32offset);
void MSC_Write(void);
