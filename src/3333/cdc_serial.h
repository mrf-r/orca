/******************************************************************************
 * @file     cdc_serial.h
 * @brief    NUC123 series USB VCOM header file
 *
 * @note
...
# define UART_MFP_INIT()
// # define UART_MFP_INIT() SYS->GPB_MFP = (SYS->GPB_MFP & ~(SYS_GPB_MFP_PB0_Msk | SYS_GPB_MFP_PB1_Msk)) | (SYS_GPB_MFP_PB0_UART0_RXD | SYS_GPB_MFP_PB1_UART0_TXD)
#elif UART_PORT == 1
# define UART            UART1
# define UART_IRQn       UART1_IRQn
# define UART_IRQHandler UART1_IRQHandler
# define UART_MODULE     UART1_MODULE
# define UART_MFP_INIT() SYS->GPB_MFP = (SYS->GPB_MFP & ~(SYS_GPB_MFP_PB4_Msk | SYS_GPB_MFP_PB5_Msk)) | (SYS_GPB_MFP_PB4_UART1_RXD | SYS_GPB_MFP_PB5_UART1_TXD)
#else
# define UART        UART0
# define UART_IRQn   UART0_IRQn
# define UART_IRQHandler UART0_IRQHandler
