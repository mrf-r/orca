...
#define	EVF_INT_fld			0x00000004		// R/WC
...
//======================================================
/* For FMC Registers */
#define FMC_ISPCON         (FMC_BASE+0x000)			
#define FMC_ISPADR         (FMC_BASE+0x004)		
#define FMC_ISPDAT         (FMC_BASE+0x008)			
#define FMC_ISPCMD         (FMC_BASE+0x00C)			
#define FMC_ISPTRG         (FMC_BASE+0x010)		
